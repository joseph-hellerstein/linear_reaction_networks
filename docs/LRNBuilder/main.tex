...
system outputs from system inputs by making use of the
input-output behavior of modules
and the manner in which modules are composed.
...
However, our approach applies to a wide variety of biological systems.
